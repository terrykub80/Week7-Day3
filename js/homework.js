console.log("======Exercise 1 - Closures=======")
// Exercise 1 - Closures
...
// called printMovieInfo that will take in a movie title and then either 
// displays the movie information or logs an error with a console.warn().
